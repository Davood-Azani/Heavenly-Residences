...
namespace Heavenly_Residences_Api.Controllers
{
    [ApiController]
    ...
    public class RoomOrderController : Controller
    {
        ...
        public async Task<IActionResult> PaymentSuccessful([FromBody] RoomOrderDetailsDTO details)
        {
            ...
            if (sessionDetails.PaymentStatus == "paid")
            {
                ...
                await _emailSender.SendEmailAsync(details.Email, "Booking Confirmed - Heavenly Residences",
                    "Your booking has been confirmed at Heavenly Residences with order ID :" + details.Id);
                return Ok(result);
            }
            else
            {
